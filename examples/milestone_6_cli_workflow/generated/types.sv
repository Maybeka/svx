...
class M6BusReq extends svtypes_pkg::sv_object;
  ...
  virtual function void pack_body(ref byte unsigned bytes[$]);
    ...
    svtypes_pkg::pack_object_header("M6BusReq", 4, __svx_obj_id, bytes);
  ...
  virtual function void unpack_body(ref byte unsigned bytes[$], ref int offset);
    ...
    svtypes_pkg::unpack_object_header("M6BusReq", 4, incoming_svx_obj_id, bytes, offset);
...
class M6BusRsp extends svtypes_pkg::sv_object;
  ...
  virtual function void pack_body(ref byte unsigned bytes[$]);
    ensure_svx_obj_id();
    svtypes_pkg::register_svx_object(this);
    svtypes_pkg::pack_object_header("M6BusRsp", 3, __svx_obj_id, bytes);
    svtypes_pkg::int_packer::pack(id, bytes);
  ...
  virtual function void unpack_body(ref byte unsigned bytes[$], ref int offset);
    longint unsigned incoming_svx_obj_id;
    svtypes_pkg::unpack_object_header("M6BusRsp", 3, incoming_svx_obj_id, bytes, offset);
    __svx_obj_id = incoming_svx_obj_id;
    svtypes_pkg::register_svx_object(this);
    svtypes_pkg::int_packer::unpack(id, bytes, offset);
...
class M6BusObs extends svtypes_pkg::sv_object;
  ...
  virtual function void pack_body(ref byte unsigned bytes[$]);
    ensure_svx_obj_id();
    svtypes_pkg::register_svx_object(this);
    svtypes_pkg::pack_object_header("M6BusObs", 4, __svx_obj_id, bytes);
    svtypes_pkg::int_packer::pack(id, bytes);
    svtypes_pkg::bits_packer#(M6BusOp)::pack(op, bytes);
    svtypes_pkg::bits_packer#(bit [7:0])::pack(addr, bytes);
    svtypes_pkg::bits_packer#(bit [31:0])::pack(data, bytes);
  ...
  virtual function void unpack_body(ref byte unsigned bytes[$], ref int offset);
    longint unsigned incoming_svx_obj_id;
    svtypes_pkg::unpack_object_header("M6BusObs", 4, incoming_svx_obj_id, bytes, offset);
    __svx_obj_id = incoming_svx_obj_id;
    svtypes_pkg::register_svx_object(this);
    svtypes_pkg::int_packer::unpack(id, bytes, offset);
    svtypes_pkg::bits_packer#(M6BusOp)::unpack(op, bytes, offset);
