...
class M6BusReq extends svtypes_pkg::sv_object;
  ...
  static function svtypes_pkg::encoding_descriptor svtypes_encoding_descriptor();
    ...
    descriptor = new("milestone_6_cli_workflow.M6BusReq", "f215515b5ec8b3febe2d733df95334d5191e1a39780a41df958fb534ea40b448", 1);
    return descriptor;
  endfunction
  ...
  virtual function void pack_body(ref byte unsigned bytes[$]);
    ...
    svtypes_pkg::pack_object_header("milestone_6_cli_workflow.M6BusReq", "f215515b5ec8b3febe2d733df95334d5191e1a39780a41df958fb534ea40b448", 4, __svtypes_object_number, bytes);
    svtypes_pkg::int_packer::pack(id, bytes);
    svtypes_pkg::bits_packer#(M6BusOp)::pack(op, bytes);
  ...
  virtual function void unpack_body(ref byte unsigned bytes[$], ref int offset);
    ...
    svtypes_pkg::unpack_object_header("milestone_6_cli_workflow.M6BusReq", "f215515b5ec8b3febe2d733df95334d5191e1a39780a41df958fb534ea40b448", 4, incoming_svtypes_object_number, bytes, offset);
    __svtypes_object_number = incoming_svtypes_object_number;
    svtypes_pkg::register_object(this);
    svtypes_pkg::int_packer::unpack(id, bytes, offset);
    svtypes_pkg::bits_packer#(M6BusOp)::unpack(op, bytes, offset);
...
class M6BusRsp extends svtypes_pkg::sv_object;
  ...
  static function svtypes_pkg::encoding_descriptor svtypes_encoding_descriptor();
    svtypes_pkg::encoding_descriptor descriptor;
    descriptor = new("milestone_6_cli_workflow.M6BusRsp", "81140f649abab1c51732ba066c212f81e351046ba08a520b2d7b8859f9de319e", 1);
    return descriptor;
  endfunction
  ...
  virtual function void pack_body(ref byte unsigned bytes[$]);
    ensure_svtypes_object_number();
    svtypes_pkg::register_object(this);
    svtypes_pkg::pack_object_header("milestone_6_cli_workflow.M6BusRsp", "81140f649abab1c51732ba066c212f81e351046ba08a520b2d7b8859f9de319e", 3, __svtypes_object_number, bytes);
    svtypes_pkg::int_packer::pack(id, bytes);
  ...
  virtual function void unpack_body(ref byte unsigned bytes[$], ref int offset);
    longint unsigned incoming_svtypes_object_number;
    svtypes_pkg::unpack_object_header("milestone_6_cli_workflow.M6BusRsp", "81140f649abab1c51732ba066c212f81e351046ba08a520b2d7b8859f9de319e", 3, incoming_svtypes_object_number, bytes, offset);
    __svtypes_object_number = incoming_svtypes_object_number;
    svtypes_pkg::register_object(this);
    svtypes_pkg::int_packer::unpack(id, bytes, offset);
...
class M6BusObs extends svtypes_pkg::sv_object;
  ...
  static function svtypes_pkg::encoding_descriptor svtypes_encoding_descriptor();
    svtypes_pkg::encoding_descriptor descriptor;
    descriptor = new("milestone_6_cli_workflow.M6BusObs", "f215515b5ec8b3febe2d733df95334d5191e1a39780a41df958fb534ea40b448", 1);
    return descriptor;
  endfunction
  ...
  virtual function void pack_body(ref byte unsigned bytes[$]);
    ensure_svtypes_object_number();
    svtypes_pkg::register_object(this);
    svtypes_pkg::pack_object_header("milestone_6_cli_workflow.M6BusObs", "f215515b5ec8b3febe2d733df95334d5191e1a39780a41df958fb534ea40b448", 4, __svtypes_object_number, bytes);
    svtypes_pkg::int_packer::pack(id, bytes);
    svtypes_pkg::bits_packer#(M6BusOp)::pack(op, bytes);
    svtypes_pkg::bits_packer#(bit [7:0])::pack(addr, bytes);
    svtypes_pkg::bits_packer#(bit [31:0])::pack(data, bytes);
  ...
  virtual function void unpack_body(ref byte unsigned bytes[$], ref int offset);
    longint unsigned incoming_svtypes_object_number;
    svtypes_pkg::unpack_object_header("milestone_6_cli_workflow.M6BusObs", "f215515b5ec8b3febe2d733df95334d5191e1a39780a41df958fb534ea40b448", 4, incoming_svtypes_object_number, bytes, offset);
    __svtypes_object_number = incoming_svtypes_object_number;
    svtypes_pkg::register_object(this);
    svtypes_pkg::int_packer::unpack(id, bytes, offset);
    svtypes_pkg::bits_packer#(M6BusOp)::unpack(op, bytes, offset);
...
task automatic svx_get_M6BusReq(string channel_name, output M6BusReq item);
  ...
  svx_pkg::svx_payload_to_checked_byte_queue(payload, channel_name, "M6BusReq", "milestone_6_cli_workflow.M6BusReq", "f215515b5ec8b3febe2d733df95334d5191e1a39780a41df958fb534ea40b448", 1, "svx_get_M6BusReq", bytes);
...
task automatic svx_peek_M6BusReq(string channel_name, output M6BusReq item);
  ...
  svx_pkg::svx_payload_to_checked_byte_queue(payload, channel_name, "M6BusReq", "milestone_6_cli_workflow.M6BusReq", "f215515b5ec8b3febe2d733df95334d5191e1a39780a41df958fb534ea40b448", 1, "svx_peek_M6BusReq", bytes);
  item = new();
  offset = 0;
  item.unpack(bytes, offset);
...
task automatic svx_put_M6BusReq(string channel_name, input M6BusReq item);
  ...
  item.pack(bytes);
  svx_pkg::svx_channel_put_byte_queue(channel_name, bytes, "svtypes", "M6BusReq", "application/x-svtypes", "milestone_6_cli_workflow.M6BusReq", "f215515b5ec8b3febe2d733df95334d5191e1a39780a41df958fb534ea40b448", 1);
endtask
...
task automatic svx_try_get_M6BusReq(string channel_name, output bit ok, output M6BusReq item);
  ...
  svx_pkg::svx_payload_to_checked_byte_queue(payload, channel_name, "M6BusReq", "milestone_6_cli_workflow.M6BusReq", "f215515b5ec8b3febe2d733df95334d5191e1a39780a41df958fb534ea40b448", 1, "svx_try_get_M6BusReq", bytes);
  svx_pkg::svx_payload_destroy(payload);
  item = new();
  offset = 0;
  item.unpack(bytes, offset);
...
function automatic bit svx_try_put_M6BusReq(string channel_name, input M6BusReq item);
  ...
  item.pack(bytes);
  return svx_pkg::svx_channel_try_put_byte_queue(channel_name, bytes, "svtypes", "M6BusReq", "application/x-svtypes", "milestone_6_cli_workflow.M6BusReq", "f215515b5ec8b3febe2d733df95334d5191e1a39780a41df958fb534ea40b448", 1);
endfunction
...
task automatic svx_get_M6BusRsp(string channel_name, output M6BusRsp item);
  ...
  int offset;
  svx_pkg::svx_channel_get_payload(channel_name, payload);
  svx_pkg::svx_payload_to_checked_byte_queue(payload, channel_name, "M6BusRsp", "milestone_6_cli_workflow.M6BusRsp", "81140f649abab1c51732ba066c212f81e351046ba08a520b2d7b8859f9de319e", 1, "svx_get_M6BusRsp", bytes);
  svx_pkg::svx_payload_destroy(payload);
  item = new();
  offset = 0;
  item.unpack(bytes, offset);
...
task automatic svx_peek_M6BusRsp(string channel_name, output M6BusRsp item);
  ...
  int offset;
  svx_pkg::svx_channel_peek_payload(channel_name, payload);
  svx_pkg::svx_payload_to_checked_byte_queue(payload, channel_name, "M6BusRsp", "milestone_6_cli_workflow.M6BusRsp", "81140f649abab1c51732ba066c212f81e351046ba08a520b2d7b8859f9de319e", 1, "svx_peek_M6BusRsp", bytes);
  item = new();
  offset = 0;
  item.unpack(bytes, offset);
...
task automatic svx_put_M6BusRsp(string channel_name, input M6BusRsp item);
  ...
  item.pack(bytes);
  svx_pkg::svx_channel_put_byte_queue(channel_name, bytes, "svtypes", "M6BusRsp", "application/x-svtypes", "milestone_6_cli_workflow.M6BusRsp", "81140f649abab1c51732ba066c212f81e351046ba08a520b2d7b8859f9de319e", 1);
endtask
...
task automatic svx_try_get_M6BusRsp(string channel_name, output bit ok, output M6BusRsp item);
  ...
  svx_pkg::svx_payload_to_checked_byte_queue(payload, channel_name, "M6BusRsp", "milestone_6_cli_workflow.M6BusRsp", "81140f649abab1c51732ba066c212f81e351046ba08a520b2d7b8859f9de319e", 1, "svx_try_get_M6BusRsp", bytes);
  svx_pkg::svx_payload_destroy(payload);
  item = new();
  offset = 0;
  item.unpack(bytes, offset);
...
function automatic bit svx_try_put_M6BusRsp(string channel_name, input M6BusRsp item);
  ...
  item.pack(bytes);
  return svx_pkg::svx_channel_try_put_byte_queue(channel_name, bytes, "svtypes", "M6BusRsp", "application/x-svtypes", "milestone_6_cli_workflow.M6BusRsp", "81140f649abab1c51732ba066c212f81e351046ba08a520b2d7b8859f9de319e", 1);
endfunction
...
task automatic svx_get_M6BusObs(string channel_name, output M6BusObs item);
  ...
  int offset;
  svx_pkg::svx_channel_get_payload(channel_name, payload);
  svx_pkg::svx_payload_to_checked_byte_queue(payload, channel_name, "M6BusObs", "milestone_6_cli_workflow.M6BusObs", "f215515b5ec8b3febe2d733df95334d5191e1a39780a41df958fb534ea40b448", 1, "svx_get_M6BusObs", bytes);
  svx_pkg::svx_payload_destroy(payload);
  item = new();
  offset = 0;
  item.unpack(bytes, offset);
...
task automatic svx_peek_M6BusObs(string channel_name, output M6BusObs item);
  ...
  int offset;
  svx_pkg::svx_channel_peek_payload(channel_name, payload);
  svx_pkg::svx_payload_to_checked_byte_queue(payload, channel_name, "M6BusObs", "milestone_6_cli_workflow.M6BusObs", "f215515b5ec8b3febe2d733df95334d5191e1a39780a41df958fb534ea40b448", 1, "svx_peek_M6BusObs", bytes);
  item = new();
  offset = 0;
  item.unpack(bytes, offset);
...
task automatic svx_put_M6BusObs(string channel_name, input M6BusObs item);
  ...
  item.pack(bytes);
  svx_pkg::svx_channel_put_byte_queue(channel_name, bytes, "svtypes", "M6BusObs", "application/x-svtypes", "milestone_6_cli_workflow.M6BusObs", "f215515b5ec8b3febe2d733df95334d5191e1a39780a41df958fb534ea40b448", 1);
endtask
...
task automatic svx_try_get_M6BusObs(string channel_name, output bit ok, output M6BusObs item);
  ...
  svx_pkg::svx_payload_to_checked_byte_queue(payload, channel_name, "M6BusObs", "milestone_6_cli_workflow.M6BusObs", "f215515b5ec8b3febe2d733df95334d5191e1a39780a41df958fb534ea40b448", 1, "svx_try_get_M6BusObs", bytes);
  svx_pkg::svx_payload_destroy(payload);
  item = new();
  offset = 0;
  item.unpack(bytes, offset);
...
function automatic bit svx_try_put_M6BusObs(string channel_name, input M6BusObs item);
  ...
  item.pack(bytes);
  return svx_pkg::svx_channel_try_put_byte_queue(channel_name, bytes, "svtypes", "M6BusObs", "application/x-svtypes", "milestone_6_cli_workflow.M6BusObs", "f215515b5ec8b3febe2d733df95334d5191e1a39780a41df958fb534ea40b448", 1);
endfunction
