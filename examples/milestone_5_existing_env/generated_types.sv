...
class M5BusReq extends svtypes_pkg::sv_object;
  ...
  static function svtypes_pkg::encoding_descriptor svtypes_encoding_descriptor();
    ...
    descriptor = new("milestone_5_existing_env.M5BusReq", "3ba7dc19a9f028964a7c073ccd7f640b74991c9e2e9fc7109deb70d96ae005da", 1);
    return descriptor;
  endfunction
  ...
  virtual function void pack_body(ref byte unsigned bytes[$]);
    ...
    svtypes_pkg::pack_object_header("milestone_5_existing_env.M5BusReq", "3ba7dc19a9f028964a7c073ccd7f640b74991c9e2e9fc7109deb70d96ae005da", 4, __svtypes_object_number, bytes);
    svtypes_pkg::int_packer::pack(id, bytes);
    svtypes_pkg::bit_packer#(M5BusOp)::pack(op, bytes);
  ...
  virtual function void unpack_body(ref byte unsigned bytes[$], ref int offset);
    ...
    svtypes_pkg::unpack_object_header("milestone_5_existing_env.M5BusReq", "3ba7dc19a9f028964a7c073ccd7f640b74991c9e2e9fc7109deb70d96ae005da", 4, incoming_svtypes_object_number, bytes, offset);
    __svtypes_object_number = incoming_svtypes_object_number;
    svtypes_pkg::register_object(this);
    svtypes_pkg::int_packer::unpack(id, bytes, offset);
    svtypes_pkg::bit_packer#(M5BusOp)::unpack(op, bytes, offset);
  ...
  class M5BusReq__svtypes_coverage;
    covergroup cg with function sample(M5BusReq item);
      ...
      op: coverpoint item.op {
          ...
          option.goal = 100;
          option.weight = 1;
          bins auto_M5_OP_READ_ = {M5_OP_READ};
          bins auto_M5_OP_WRITE_ = {M5_OP_WRITE};
      }
    endgroup
...
class M5BusRsp extends svtypes_pkg::sv_object;
  ...
  static function svtypes_pkg::encoding_descriptor svtypes_encoding_descriptor();
    svtypes_pkg::encoding_descriptor descriptor;
    descriptor = new("milestone_5_existing_env.M5BusRsp", "051000b62407a733c3b7692a62a481d3d7217358946a4bf18270e6586c2b0501", 1);
    return descriptor;
  endfunction
  ...
  virtual function void pack_body(ref byte unsigned bytes[$]);
    ensure_svtypes_object_number();
    svtypes_pkg::register_object(this);
    svtypes_pkg::pack_object_header("milestone_5_existing_env.M5BusRsp", "051000b62407a733c3b7692a62a481d3d7217358946a4bf18270e6586c2b0501", 3, __svtypes_object_number, bytes);
    svtypes_pkg::int_packer::pack(id, bytes);
  ...
  virtual function void unpack_body(ref byte unsigned bytes[$], ref int offset);
    longint unsigned incoming_svtypes_object_number;
    svtypes_pkg::unpack_object_header("milestone_5_existing_env.M5BusRsp", "051000b62407a733c3b7692a62a481d3d7217358946a4bf18270e6586c2b0501", 3, incoming_svtypes_object_number, bytes, offset);
    __svtypes_object_number = incoming_svtypes_object_number;
    svtypes_pkg::register_object(this);
    svtypes_pkg::int_packer::unpack(id, bytes, offset);
...
class M5BusObs extends svtypes_pkg::sv_object;
  ...
  static function svtypes_pkg::encoding_descriptor svtypes_encoding_descriptor();
    svtypes_pkg::encoding_descriptor descriptor;
    descriptor = new("milestone_5_existing_env.M5BusObs", "3ba7dc19a9f028964a7c073ccd7f640b74991c9e2e9fc7109deb70d96ae005da", 1);
    return descriptor;
  endfunction
  ...
  virtual function void pack_body(ref byte unsigned bytes[$]);
    ensure_svtypes_object_number();
    svtypes_pkg::register_object(this);
    svtypes_pkg::pack_object_header("milestone_5_existing_env.M5BusObs", "3ba7dc19a9f028964a7c073ccd7f640b74991c9e2e9fc7109deb70d96ae005da", 4, __svtypes_object_number, bytes);
    svtypes_pkg::int_packer::pack(id, bytes);
    svtypes_pkg::bit_packer#(M5BusOp)::pack(op, bytes);
    svtypes_pkg::bit_packer#(bit [7:0])::pack(addr, bytes);
    svtypes_pkg::bit_packer#(bit [31:0])::pack(data, bytes);
  ...
  virtual function void unpack_body(ref byte unsigned bytes[$], ref int offset);
    longint unsigned incoming_svtypes_object_number;
    svtypes_pkg::unpack_object_header("milestone_5_existing_env.M5BusObs", "3ba7dc19a9f028964a7c073ccd7f640b74991c9e2e9fc7109deb70d96ae005da", 4, incoming_svtypes_object_number, bytes, offset);
    __svtypes_object_number = incoming_svtypes_object_number;
    svtypes_pkg::register_object(this);
    svtypes_pkg::int_packer::unpack(id, bytes, offset);
    svtypes_pkg::bit_packer#(M5BusOp)::unpack(op, bytes, offset);
...
task automatic svx_get_M5BusReq(string channel_name, output M5BusReq item);
  ...
  svx_pkg::svx_payload_to_checked_byte_queue(payload, channel_name, "M5BusReq", "milestone_5_existing_env.M5BusReq", "3ba7dc19a9f028964a7c073ccd7f640b74991c9e2e9fc7109deb70d96ae005da", 1, "svx_get_M5BusReq", bytes);
...
task automatic svx_peek_M5BusReq(string channel_name, output M5BusReq item);
  ...
  svx_pkg::svx_payload_to_checked_byte_queue(payload, channel_name, "M5BusReq", "milestone_5_existing_env.M5BusReq", "3ba7dc19a9f028964a7c073ccd7f640b74991c9e2e9fc7109deb70d96ae005da", 1, "svx_peek_M5BusReq", bytes);
  item = new();
  offset = 0;
  item.unpack(bytes, offset);
...
task automatic svx_put_M5BusReq(string channel_name, input M5BusReq item);
  ...
  item.pack(bytes);
  svx_pkg::svx_channel_put_byte_queue(channel_name, bytes, "svtypes", "M5BusReq", "application/x-svtypes", "milestone_5_existing_env.M5BusReq", "3ba7dc19a9f028964a7c073ccd7f640b74991c9e2e9fc7109deb70d96ae005da", 1);
endtask
...
task automatic svx_try_get_M5BusReq(string channel_name, output bit ok, output M5BusReq item);
  ...
  svx_pkg::svx_payload_to_checked_byte_queue(payload, channel_name, "M5BusReq", "milestone_5_existing_env.M5BusReq", "3ba7dc19a9f028964a7c073ccd7f640b74991c9e2e9fc7109deb70d96ae005da", 1, "svx_try_get_M5BusReq", bytes);
  svx_pkg::svx_payload_destroy(payload);
  item = new();
  offset = 0;
  item.unpack(bytes, offset);
...
function automatic bit svx_try_put_M5BusReq(string channel_name, input M5BusReq item);
  ...
  item.pack(bytes);
  return svx_pkg::svx_channel_try_put_byte_queue(channel_name, bytes, "svtypes", "M5BusReq", "application/x-svtypes", "milestone_5_existing_env.M5BusReq", "3ba7dc19a9f028964a7c073ccd7f640b74991c9e2e9fc7109deb70d96ae005da", 1);
endfunction
...
task automatic svx_get_M5BusRsp(string channel_name, output M5BusRsp item);
  ...
  int offset;
  svx_pkg::svx_channel_get_payload(channel_name, payload);
  svx_pkg::svx_payload_to_checked_byte_queue(payload, channel_name, "M5BusRsp", "milestone_5_existing_env.M5BusRsp", "051000b62407a733c3b7692a62a481d3d7217358946a4bf18270e6586c2b0501", 1, "svx_get_M5BusRsp", bytes);
  svx_pkg::svx_payload_destroy(payload);
  item = new();
  offset = 0;
  item.unpack(bytes, offset);
...
task automatic svx_peek_M5BusRsp(string channel_name, output M5BusRsp item);
  ...
  int offset;
  svx_pkg::svx_channel_peek_payload(channel_name, payload);
  svx_pkg::svx_payload_to_checked_byte_queue(payload, channel_name, "M5BusRsp", "milestone_5_existing_env.M5BusRsp", "051000b62407a733c3b7692a62a481d3d7217358946a4bf18270e6586c2b0501", 1, "svx_peek_M5BusRsp", bytes);
  item = new();
  offset = 0;
  item.unpack(bytes, offset);
...
task automatic svx_put_M5BusRsp(string channel_name, input M5BusRsp item);
  ...
  item.pack(bytes);
  svx_pkg::svx_channel_put_byte_queue(channel_name, bytes, "svtypes", "M5BusRsp", "application/x-svtypes", "milestone_5_existing_env.M5BusRsp", "051000b62407a733c3b7692a62a481d3d7217358946a4bf18270e6586c2b0501", 1);
endtask
...
task automatic svx_try_get_M5BusRsp(string channel_name, output bit ok, output M5BusRsp item);
  ...
  svx_pkg::svx_payload_to_checked_byte_queue(payload, channel_name, "M5BusRsp", "milestone_5_existing_env.M5BusRsp", "051000b62407a733c3b7692a62a481d3d7217358946a4bf18270e6586c2b0501", 1, "svx_try_get_M5BusRsp", bytes);
  svx_pkg::svx_payload_destroy(payload);
  item = new();
  offset = 0;
  item.unpack(bytes, offset);
...
function automatic bit svx_try_put_M5BusRsp(string channel_name, input M5BusRsp item);
  ...
  item.pack(bytes);
  return svx_pkg::svx_channel_try_put_byte_queue(channel_name, bytes, "svtypes", "M5BusRsp", "application/x-svtypes", "milestone_5_existing_env.M5BusRsp", "051000b62407a733c3b7692a62a481d3d7217358946a4bf18270e6586c2b0501", 1);
endfunction
...
task automatic svx_get_M5BusObs(string channel_name, output M5BusObs item);
  ...
  int offset;
  svx_pkg::svx_channel_get_payload(channel_name, payload);
  svx_pkg::svx_payload_to_checked_byte_queue(payload, channel_name, "M5BusObs", "milestone_5_existing_env.M5BusObs", "3ba7dc19a9f028964a7c073ccd7f640b74991c9e2e9fc7109deb70d96ae005da", 1, "svx_get_M5BusObs", bytes);
  svx_pkg::svx_payload_destroy(payload);
  item = new();
  offset = 0;
  item.unpack(bytes, offset);
...
task automatic svx_peek_M5BusObs(string channel_name, output M5BusObs item);
  ...
  int offset;
  svx_pkg::svx_channel_peek_payload(channel_name, payload);
  svx_pkg::svx_payload_to_checked_byte_queue(payload, channel_name, "M5BusObs", "milestone_5_existing_env.M5BusObs", "3ba7dc19a9f028964a7c073ccd7f640b74991c9e2e9fc7109deb70d96ae005da", 1, "svx_peek_M5BusObs", bytes);
  item = new();
  offset = 0;
  item.unpack(bytes, offset);
...
task automatic svx_put_M5BusObs(string channel_name, input M5BusObs item);
  ...
  item.pack(bytes);
  svx_pkg::svx_channel_put_byte_queue(channel_name, bytes, "svtypes", "M5BusObs", "application/x-svtypes", "milestone_5_existing_env.M5BusObs", "3ba7dc19a9f028964a7c073ccd7f640b74991c9e2e9fc7109deb70d96ae005da", 1);
endtask
...
task automatic svx_try_get_M5BusObs(string channel_name, output bit ok, output M5BusObs item);
  ...
  svx_pkg::svx_payload_to_checked_byte_queue(payload, channel_name, "M5BusObs", "milestone_5_existing_env.M5BusObs", "3ba7dc19a9f028964a7c073ccd7f640b74991c9e2e9fc7109deb70d96ae005da", 1, "svx_try_get_M5BusObs", bytes);
  svx_pkg::svx_payload_destroy(payload);
  item = new();
  offset = 0;
  item.unpack(bytes, offset);
...
function automatic bit svx_try_put_M5BusObs(string channel_name, input M5BusObs item);
  ...
  item.pack(bytes);
  return svx_pkg::svx_channel_try_put_byte_queue(channel_name, bytes, "svtypes", "M5BusObs", "application/x-svtypes", "milestone_5_existing_env.M5BusObs", "3ba7dc19a9f028964a7c073ccd7f640b74991c9e2e9fc7109deb70d96ae005da", 1);
endfunction
